...
public class TrainingConfiguration {
    ...
    static {
        CHEST_TRAINING = new Training("Trening klatki piersiowej", TrainingType.REPS, TrainingArea.CHEST, 30, List.of(
        ...
        STRECH_TRAINING = new Training("Rozciąganie", TrainingType.TIME, TrainingArea.STRETCH, 15, Arrays.asList(
