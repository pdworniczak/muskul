...
public class TrainingConfiguration {
    ...
    static {
        CHEST_TRAINING = new Training("Trening klatki piersiowej", TrainingFormat.REPS, TrainingType.CHEST, 30,
                List.of(
        ...
        STRECH_TRAINING = new Training("Rozciąganie", TrainingFormat.TIME, TrainingType.STRETCH, 15,
                Arrays.asList(
